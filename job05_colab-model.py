...
train_x, test_x = np.load('./CycleGAN-master/datasets/mone_image.npy', allow_pickle = True) # pickle 은 객체의 형태를 그대로 유지하며 저장
train_y, test_y = np.load('./CycleGAN-master/datasets/picture_image.npy', allow_pickle = True) # pickle 은 객체의 형태를 그대로 유지하며 저장
